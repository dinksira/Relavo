  ...
  return (
    <div className="min-h-screen bg-white flex overflow-hidden">
      ...
      <div className="w-full lg:w-[580px] flex flex-col p-8 md:p-12 relative z-10 bg-white shadow-2xl">
        <div className="mb-4">
          <Link to="/login" className="inline-flex items-center gap-2 text-[10px] font-black text-relavo-navy/40 uppercase tracking-[0.2em] hover:text-relavo-blue transition-colors group">
          ...
          {!isSent ? (
            <>
              <div className="space-y-2 mb-10">
                <h1 className="text-3xl font-black text-relavo-navy tracking-tight">Reset Password.</h1>
                <p className="text-relavo-text-secondary text-sm font-medium">Enter your email and we'll send you a recovery link.</p>
              </div>
            ...
            <div className="text-center space-y-6 animate-reveal">
              ...
              <div className="space-y-2">
                <h2 className="text-3xl font-black text-relavo-navy tracking-tight">Email Sent.</h2>
                <p className="text-relavo-text-secondary text-sm font-medium">Check your inbox for <b>{email}</b>. We've sent a secure link to reset your password.</p>
              </div>
              <button 
                onClick={() => setIsSent(false)}
                className="text-sm font-bold text-relavo-blue hover:underline"
              >
        ...
        <div className="mt-4 pt-6 border-t border-slate-100 flex justify-between items-center text-[9px] font-black text-relavo-navy/40 uppercase tracking-[0.2em]">
          <span>&copy; 2026 relavo inc.</span>
          <div className="flex gap-4">
            <a href="#" className="hover:text-relavo-navy transition-colors">Security</a>
            <a href="#" className="hover:text-relavo-navy transition-colors">Support</a>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-12">
               ...
               <div className="space-y-6">
                  <h2 className="text-5xl font-black text-white leading-[1.1] tracking-tight">
                    Secure <br />
                    <span className="text-relavo-blue">Access</span> Monitoring.
                  </h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-6 bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl space-y-2">
                     <Key className="text-relavo-blue" size={24} />
