    ...
    <div className="flex min-h-screen bg-white selection:bg-relavo-blue/10">
      ...
      <aside className="w-[280px] flex-shrink-0 border-r border-relavo-border flex flex-col fixed h-full bg-white z-40">
        ...
        <div className="px-6 mb-8 shrink-0">
           <div className="bg-gradient-to-br from-relavo-blue to-relavo-blueDark p-6 rounded-[24px] text-white shadow-xl relative overflow-hidden group border border-white/10">
        ...
        <div className="p-8 border-t border-relavo-border bg-slate-50/50 shrink-0">
      ...
      <div className="flex-1 ml-[280px] flex flex-col min-h-screen">
        {/* TOP BAR */}
        <header className="h-24 px-12 border-b border-relavo-border sticky top-0 bg-white/30 backdrop-blur-xl z-30 flex items-center justify-between">
           <div className="flex items-center gap-10">
              <div className="flex items-center gap-3">
                 <span className="text-xs font-black text-relavo-text-muted uppercase tracking-widest opacity-40">System</span>
                 <span className="text-relavo-border">/</span>
                 <h2 className="text-sm font-black text-relavo-navy uppercase tracking-[0.2em]">{getPageTitle()}</h2>
              </div>
              
              <div className="relative group hidden xl:block">
                 <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-relavo-text-muted group-focus-within:text-relavo-blue transition-colors" size={16} />
                 <input 
                   type="text" 
                   placeholder="Global AI Search..." 
                   className="w-[340px] pl-14 pr-6 py-2.5 bg-slate-50 border border-relavo-border rounded-xl text-xs font-bold focus:outline-none focus:ring-4 focus:ring-relavo-blue/10 transition-all"
                 />
              </div>
           ...
           <div className="flex items-center gap-6">
              <button className="hidden lg:flex items-center gap-2 px-5 py-2.5 bg-relavo-navy text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:shadow-lg hover:shadow-relavo-navy/20 transition-all active:scale-95">
              ...
              <div className="flex items-center gap-3">
                 <button className="p-3 text-relavo-text-muted hover:text-relavo-blue transition-all" title="Help & Support">
                    <HelpCircle size={18} />
                 </button>
                 <button className="p-3 bg-slate-50 border border-relavo-border rounded-xl text-relavo-text-muted hover:text-relavo-blue hover:bg-white hover:shadow-lg transition-all relative">
                    <Bell size={18} />
                    <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-relavo-blue rounded-full ring-2 ring-white"></span>
                 </button>
              </div>
              ...
              <div className="flex items-center gap-4 cursor-pointer group">
                 <div className="text-right hidden sm:block">
                    <p className="text-[10px] font-black text-relavo-navy uppercase tracking-widest">Agency Space</p>
                    <p className="text-[9px] text-relavo-text-muted font-bold uppercase">Personal Pro</p>
                 </div>
                 <div className="w-10 h-10 rounded-xl bg-relavo-navy text-white flex items-center justify-center font-black text-xs group-hover:scale-110 transition-transform shadow-lg">
                    R
                 </div>
                 <ChevronDown size={14} className="text-relavo-text-muted group-hover:text-relavo-navy transition-colors" />
              </div>
           </div>
        </header>
